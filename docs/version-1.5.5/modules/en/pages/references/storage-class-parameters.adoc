...
____
Default: `ext4` +
For more details, see xref:volumes-and-nodes/create-volumes.adoc#_creating_longhorn_volumes_with_kubectl[Creating Longhorn Volumes with Kubernetes]
____
...
____
Default: `""` +
See xref:advanced-resources/backing-image.adoc#_create_and_use_a_backing_image_via_storageclass_and_pvc[Backing Image]
____
...
More details in xref:volumes-and-nodes/scheduling.adoc[Scheduling] and xref:best-practices.adoc#_replica_node_level_soft_anti_affinity[Best Practices].
____
...
____
More details in xref:advanced-resources/rwx-workloads.adoc#_configuring_volume_mount_options[RWX Workloads]
____
