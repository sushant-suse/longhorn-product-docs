...
xref:nodes-and-volumes/nodes/disks-or-nodes-eviction.adoc[evict the replica to other nodes before draining]. See <<node-drain-policy-recommendations,Node Drain Policy
