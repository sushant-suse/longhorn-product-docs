...
| *Status Fields*
| `READYTOUSE` becomes `false` and the snapshot is marked as `Removed`.
...
For a broader comparison, see xref:v1-v2-volume-behavior-and-feature-parity.adoc[V1 and V2 Volume Feature Support].
