...
* Release Notes
** xref:release-notes/v1.12.1.adoc[]
...
// Volume Behavior and Feature Parity Section:
* xref:v1-v2-volume-behavior-and-feature-parity.adoc[]
...
*** xref:upgrades/longhorn-components/instance-manager-pods-during-upgrade.adoc[]
...
** xref:nodes/topology-aware-provisioning.adoc[]
** xref:nodes/graceful-node-removal.adoc[]
** Managed Kubernetes
...
** xref:volumes/containerized-data-importer.adoc[]
...
// V2 Data Engine Section:
* V2 Data Engine
** xref:v2-data-engine/configurable-cpu-cores.adoc[]
** xref:v2-data-engine/interrupt-mode.adoc[]
** xref:v2-data-engine/selective-engine-activation.adoc[]
** xref:v2-data-engine/sharding.adoc[]
** xref:v2-data-engine/ublk-frontend-support.adoc[]
...
*** xref:snapshots-backups/csi-snapshots/csi-volume-group-snapshot.adoc[]
...
*** xref:snapshots-backups/csi-snapshots/enable-csi-volume-group-snapshot-support.adoc[]
...
** xref:snapshots-backups/snapshot-groups.adoc[]

// Data Integrity and Recovery Section:
* Data Integrity and Recovery
** xref:data-integrity-recovery/snapshot-data-integrity-check.adoc[]
** xref:data-integrity-recovery/on-demand-snapshot-data-integrity.adoc[]
