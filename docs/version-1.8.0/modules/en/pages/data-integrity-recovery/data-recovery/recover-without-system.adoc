 ...
 ** The credential secret can be referenced https://documentation.suse.com/cloudnative/storage/1.8.0/en/snapshots-backups/volume-snapshots-backups/configure-backup-target.html#_set_up_aws_s3_backupstore[here] and must be created in the `longhorn-system' namespace.
