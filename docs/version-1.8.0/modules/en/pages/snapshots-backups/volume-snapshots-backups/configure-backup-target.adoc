...
For more information about how the backupstore works in Longhorn, see the xref:introduction/concepts.adoc#_3_backups_and_secondary_storage[concepts section.]
