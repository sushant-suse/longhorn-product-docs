...
When the backup target is configured on the UI (*Setting -> Backup Target*), {longhorn-product-name} can connect to the backupstore and display a list of existing backups on the *Backup* screen.
