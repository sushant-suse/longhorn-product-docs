...
* Refer to the https://docs.apps.rancher.io/get-started/first-steps/#authentication-methods[AppCo documentation] for instructions on authenticating to the OCI registry using Helm.
