...
* To authenticate with the Application Collection chart repository, refer to https://docs.apps.rancher.io/get-started/authentication/#helm[helm authentication guide] for instructions.
* To authenticate with the Application Collection OCI registry, refer to https://docs.apps.rancher.io/get-started/authentication/#kubernetes[kubernetes authentication guide] for steps to create a Kubernetes secret and specify it as the `global.imagePullSecrets` chart value.
