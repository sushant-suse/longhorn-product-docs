...
* When running the helm command, validate authentication via https://docs.apps.rancher.io/get-started/authentication/#helm[Helm] is required.
* Rancher uses Kubernetes secrets to authenticate registry access via https://docs.apps.rancher.io/get-started/authentication/#kubernetes[authentication guide].
