...
[NOTE]
====
Authentication to AppCo is necessary when running this script, as it uses Helm internally. For more information, refer to the https://docs.apps.rancher.io/get-started/authentication/#helm[Helm authentication documentation].
====
