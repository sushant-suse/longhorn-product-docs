...
*Recommended Alternative*: To ensure continued support and security, we recommend using the *Traefik Ingress* method to expose the Longhorn UI. See xref:longhorn-system/system-access/longhorn-ingress-traefik.adoc[Create an Ingress with Traefik] for more details.
====
