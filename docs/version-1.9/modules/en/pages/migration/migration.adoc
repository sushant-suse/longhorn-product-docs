...
If your existing Longhorn installation was deployed via Rancher Apps and Marketplace, you will see two Helm releases associated with Longhorn when running `helm list --all-namespaces | grep longhorn`.
