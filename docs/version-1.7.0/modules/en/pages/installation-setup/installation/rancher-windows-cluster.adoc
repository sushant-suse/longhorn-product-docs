...
Please follow the instruction at xref:nodes/node-selector.adoc[Node Selector] to set node selector for Longhorn.
...
Please follow the instruction at xref:nodes/taints-tolerations.adoc[Taint Toleration] to set toleration for Longhorn.
