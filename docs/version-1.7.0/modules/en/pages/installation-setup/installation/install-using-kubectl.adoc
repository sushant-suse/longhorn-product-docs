= Install SUSE® Storage Using Kubectl
:description: Install Longhorn with the kubectl client.
:current-version: {page-component-version}

== Prerequisites

Each node in the Kubernetes cluster where Longhorn will be installed must fulfill xref:../../installation-setup/requirements.adoc[these requirements.]
...
The initial settings for Longhorn can be customized by xref:../../longhorn-system/customize-default-settings.adoc#_using_the_longhorn_deployment_yaml_file[editing the deployment configuration file.]
