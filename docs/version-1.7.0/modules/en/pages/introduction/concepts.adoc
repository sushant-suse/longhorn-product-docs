...
For an overview of Longhorn features, refer to xref:introduction/introduction.adoc[this section.]
...
Besides, the space usage of the cluster worker nodes is collected and illustrated by the Longhorn UI. See xref:nodes/node-space-usage.adoc[here] for details.
