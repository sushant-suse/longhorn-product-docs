...
You can find more detail about the setting options in the `Pod Deletion Policy When Node is Down` in the *Settings* tab in the Longhorn UI or xref:references/settings.adoc#_pod_deletion_policy_when_node_is_down[Settings reference]
