...
solutions that use this upgrade methods are https://documentation.suse.com/cloudnative/k3s/latest/en/upgrades/automated.html[{k3s-product-name} automated upgrades], https://rancher.com/docs/rancher/v2.x/en/cluster-admin/upgrading-kubernetes/#upgrading-the-kubernetes-version[Rancher's
Kubernetes upgrade
guide],
