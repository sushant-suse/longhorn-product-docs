...
. you have configured `MINIO_DOMAIN` environment variable to https://min.io/docs/minio/linux/reference/minio-mc-admin.html[enable virtual-host-style requests for the MinIO server];
