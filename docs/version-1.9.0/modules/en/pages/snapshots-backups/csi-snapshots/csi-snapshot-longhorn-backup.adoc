...
Longhorn performs incremental backups by default. Add the `backupMode: full` parameter to create a full backup. For more information about `backupMode`, see xref:../volume-snapshots-backups/create-backup.adoc[Create A Backup].
