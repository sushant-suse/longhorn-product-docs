...
| Raw SMART health attribute value for the disk. Available only when SMART data is supported. See xref:observability/disk-health.md[Disk Health Monitoring] for details
