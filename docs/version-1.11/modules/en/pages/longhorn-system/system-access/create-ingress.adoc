...
* **Traefik Ingress**: The current default for RKE2/K3s environments. See xref:longhorn-system/system-access/longhorn-ingress-traefik.adoc[Create an Ingress with Traefik].
* **Gateway API**: The modern successor to Ingress for advanced routing. See xref:longhorn-system/system-access/longhorn-httproute.adoc[Create an HTTPRoute with Gateway API].
====
