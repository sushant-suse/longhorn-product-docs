...
By default, this setting applies only to Longhorn's data-plan traffic path. For RWX (Read-Write-Many) volume endpoint traffic, see  <<_endpoint_network_for_rwx_volume_enabled,Endpoint Network for RWX Volume>>.
