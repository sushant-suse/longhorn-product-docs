...
* Longhorn does not restore xref:_configurable_settings[configurable settings].
...
WARNING: Deleting the SystemRestore also deletes the associated job and will abort the remaining resource rollouts. You can xref:_restart_longhorn_system_restore[Restart the Longhorn System Restore] to roll out the remaining resources.
