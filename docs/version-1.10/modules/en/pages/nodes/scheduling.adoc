...
* {longhorn-product-name} will not schedule the new replica on Disk X. It will instead attempt to schedule it on Disk Y.
* If Disk Y is not suitable (for example, mismatched disk tags), scheduling for this replica will fail.
