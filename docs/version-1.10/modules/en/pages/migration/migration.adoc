...
+
After running the command `bash ./download-longhorn-crd-chart.sh 108.2.0+up1.10.1`, the `longhorn-crd` chart will be downloaded to the local directory `108.2.0+up1.10.1`. Then, open `108.2.0+up1.10.1/Chart.yaml` to verify that the chart version matches `108.2.0+up1.10.1`.
