...
* All settings will be restored. But the node & disk configurations would not be applied.
...
. Restore the cluster backup. For example:
+
[subs="+attributes",bash]
----
...
[NOTE]
====
We will enhance Longhorn system so that users do not need to apply step3 and step8 in the future.
====
