...
* *Huge pages configuration*: Ensure 2 GiB of 2 MiB-sized huge pages (1024 pages) are configured persistently on each V2 node via kernel boot parameters. See xref:deploy/install.adoc#_enable_hugepages[Enable HugePages] for detailed instructions.
