...
All the existing scheduled replica on the node or disk would not be affected by the new tags.
...
Alternatively, a custom storageClass setting can be used. For example:
