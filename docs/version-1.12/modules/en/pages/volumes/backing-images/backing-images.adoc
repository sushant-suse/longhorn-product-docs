...
. As mentioned in the section xref:clean_up_backing_images_in_disks[clean up backing images in disks], the file is cleaned up automatically if all replicas in one disk do not use one backing image file.
