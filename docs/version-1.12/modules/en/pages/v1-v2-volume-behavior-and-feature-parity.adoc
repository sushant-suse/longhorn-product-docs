...
| Snapshot | ✔️ | ✔️ | -
| Backup and Restore | ✔️ | ✔️ | Cross-engine backup and restore (for example, restoring a V1 volume backup as a V2 volume) is supported and serves as an offline volume migration method.
| DR Volume | ✔️ | ✔️ | -
...
| Volume Cloning | ✔️ | ✔️ | -
| Fast Volume Cloning | Not Planned | Planned | Planned for {longhorn-product-name} v1.12.1
...
|===
| Feature | V1 | V2 | Support Notes
| Engine Live Upgrade | ✔️ | Not supported | V2 volumes do not support live upgrades between {longhorn-product-name} v1.12 patch releases and must be detached before upgrading. Support is planned when upgrading from a {longhorn-product-name} v1.12 release to a {longhorn-product-name} v1.13 release.
|===
...
|===
| Feature | V1 | V2 | Support Notes
| Storage Sharding | Not planned | Planned | Planned as an experimental feature for {longhorn-product-name} v1.12.1.
|===
