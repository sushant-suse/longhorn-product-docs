...
we introduce a new setting, xref:deploy/references/settings.adoc#deleting-confirmation-flag[deleting-confirmation-flag].
...
volumes have only one replica. See the new xref:deploy/volumes-and-nodes/maintenance.adoc#node-drain-policy-recommendations[Node Drain Policy
...
Please use the new setting xref:deploy/references/settings.adoc#node-drain-policy[Node Drain Policy] instead.
